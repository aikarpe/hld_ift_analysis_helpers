...
cd C:\Users\admin\Documents\Data\aikars\opentron\surfactant_scan_template
...
python %SCRIPT%\2D_HLD_scan_v2__setup_configuration.py %SETTINGS%

python %SCRIPT%\2D_HLD_scan_v2__execute.py %SETTINGS%
