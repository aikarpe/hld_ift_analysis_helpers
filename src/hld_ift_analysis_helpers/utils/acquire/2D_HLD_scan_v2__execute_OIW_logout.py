...
from hld_ift_http.hld_scan_1d import Scan_Graph, HLD_IFT_2D_Scan_log_outer_W_Slider #HLD_IFT_2D_Scan_W_Slider
...
from hld_ift_http.opentron_well_status import pretty_config_make
...
scan_outer = Scan_Graph(
                a_mixing_graph = mixing_graph,
                well_1 = stock_wt,
                well_2 = stock_NaCl,
                scan_label = f"scan_outer_{suffix_out}",
                wells_to_use = to_use
                )
...
pps = {
    ...
    'lst_roles': {'2/A1': "SMPL WST", '2/A2': "WASH1 WST", '2/A3': "WASH2 WST", '2/A4': "WASH1"}
}
...
if "restart_index" not in  hld_scan_args.keys(): 
    hld_scan_args["restart_index"] = 0


hld_scan = HLD_IFT_2D_Scan_log_outer_W_Slider(
                opentron = op,
                ...
                volume_min_stock_outer = 300,
                outer_fluid_graph = scan_outer, #Scan_Graph
                scan_params = {}
                )
