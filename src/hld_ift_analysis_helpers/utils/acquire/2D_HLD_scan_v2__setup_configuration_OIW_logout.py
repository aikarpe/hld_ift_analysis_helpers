...
#=======================================================================================================
# slot 9  "load_name": "3dprinted_50_tuberack_50000ul",
#=======================================================================================================
#       1               2                   3               
#
...
inputs = [
dict(address =         stock_wt_exp, name =      stock_names["stock_aqueous_1"], volume = 45000),
dict(address =       stock_nacl_exp, name =      stock_names["stock_aqueous_2"], volume = 45000),
