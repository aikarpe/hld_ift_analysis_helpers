...
#       1                       2                   3               4                   5
#
# A:    stock_surf_oil_1        stock_surf_oil_2    stock_oil_1     stock_oil_2         hex_decane        
#       12000                   12000               12000           12000               12000
#
# B:    run_stock_surf_oil_1    sample_80_20        sample_60_40    sample_40_60        sample_20_80 
#       empty                   empty               empty           empty               empty   
#
# C:    run_stock_surf_oil_2    
#       empty
#=======================================================================================================
...
# ............................................................ inputs
suffix_in = "hld_ift_experiment_OIW_blank"
...
dict(address =         stock_wt, solution =                       "hexadecane", volume = 12000) 
]
...
run_stock_surf_oil_1    = Well_Address("9", "B1") if use_status else stock_surf_oil_1 
run_stock_surf_oil_2    = Well_Address("9", "C1") if use_status else stock_surf_oil_2

sample_80_20            = Well_Address("9", "B2")
sample_60_40            = Well_Address("9", "B3")
sample_40_60            = Well_Address("9", "B4")
sample_20_80            = Well_Address("9", "B5")
...
def fraction_name(name, fraction):
    return f'{fraction:0.3f} of ({name})'

def oil_mixture_name(fraction):
    name1 = stock_names["run_stock_surf_oil_1"]
    name2 = stock_names["run_stock_surf_oil_2"]
    return f'{fraction_name(name1, fraction)} and {fraction_name(name2, 1 - fraction)}'


mixtures = [
#dict(address = run_stock_surf_oil_1, name = stock_names["run_stock_surf_oil_1"], volume =  4000, list_qt = [ v_stock, v_solvent], list_sol = [            stock_surf_oil_1, stock_oil_1], use = v_stock != 1),
#dict(address = run_stock_surf_oil_2, name = stock_names["run_stock_surf_oil_2"], volume =  4000, list_qt = [ v_stock, v_solvent], list_sol = [            stock_surf_oil_2, stock_oil_2], use = v_stock != 1), 
#dict(address =         sample_80_20, name =               oil_mixture_name(0.8), volume =   550, list_qt = [       0.8, 1 - 0.8], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
#dict(address =         sample_60_40, name =               oil_mixture_name(0.6), volume =   550, list_qt = [       0.6, 1 - 0.6], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
#dict(address =         sample_40_60, name =               oil_mixture_name(0.4), volume =   550, list_qt = [       0.4, 1 - 0.4], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
#dict(address =         sample_20_80, name =               oil_mixture_name(0.2), volume =   550, list_qt = [       0.2, 1 - 0.2], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
#dict(address =  unused_sample_waste, name =                        "hexadecane", volume =   500, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True),
#dict(address =   sample_rinse_waste, name =                        "hexadecane", volume =   500, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True),
##dict(address =   first_rinse_source, name =                        "hexadecane", volume =  1400, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True),
#dict(address =    first_rinse_waste, name =                        "hexadecane", volume =   500, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True)

dict(
        address = run_stock_surf_oil_1 if use_status else stock_surf_oil_1, 
        name = stock_names["run_stock_surf_oil_1"] if use_status else stock_names["surfactant_in_oil_1"], 
        volume = 12500, 
        list_qt = [ v_stock, v_solvent], 
        list_sol = [            stock_surf_oil_1, stock_oil_1], 
        use = use_status),
dict(
        address = run_stock_surf_oil_2 if use_status else stock_surf_oil_2,
        name = stock_names["run_stock_surf_oil_2"] if use_status else stock_names["surfactant_in_oil_2"],
        volume = 12500,
        list_qt = [ v_stock, v_solvent],
        list_sol = [            stock_surf_oil_2, stock_oil_2],
        use = use_status), 
dict(address =         sample_80_20, name =               oil_mixture_name(0.8), volume =  4000, list_qt = [       0.8, 1 - 0.8], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
dict(address =         sample_60_40, name =               oil_mixture_name(0.6), volume =  4000, list_qt = [       0.6, 1 - 0.6], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
dict(address =         sample_40_60, name =               oil_mixture_name(0.4), volume =  4000, list_qt = [       0.4, 1 - 0.4], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
dict(address =         sample_20_80, name =               oil_mixture_name(0.2), volume =  4000, list_qt = [       0.2, 1 - 0.2], list_sol = [run_stock_surf_oil_1,run_stock_surf_oil_2], use =         True),
dict(address =  unused_sample_waste, name =                        "hexadecane", volume =   500, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True),
dict(address =   sample_rinse_waste, name =                        "hexadecane", volume =   500, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True),
#dict(address =   first_rinse_source, name =                        "hexadecane", volume =  1400, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True),
dict(address =    first_rinse_waste, name =                        "hexadecane", volume =   500, list_qt = [                  1], list_sol = [                                 stock_wt], use =         True)
...
def execute_dilution(**kwargs):
    ...
    op.make_solution(mxg, pipette, kwargs["address"], kwargs["volume"], repetitions = 0)
...
for mix_input in mixtures:
    ...
    if mix_input["use"]:
        ...
        if mix_input["name"] == stock_names["run_stock_surf_oil_2"]:
            input("... mix both prepared run stocks and put them back, hit enter when done ...")
    #    first = False
...
for mix_input in mixtures:
    if mix_input["address"] == sample_80_20:
        params_out["stocks"]["sample_80_20"] = mix_input["name"]
    if mix_input["address"] == sample_60_40:
        params_out["stocks"]["sample_60_40"] = mix_input["name"]
    if mix_input["address"] == sample_40_60:
        params_out["stocks"]["sample_40_60"] = mix_input["name"]
    if mix_input["address"] == sample_20_80:
        params_out["stocks"]["sample_20_80"] = mix_input["name"]
