...
run_stock_aqueous_1        = Well_Address("9", "A1")
run_stock_aqueous_2        = Well_Address("9", "A2")
...
inputs = [
dict(address =  run_stock_aqueous_1, name =  stock_names["run_stock_aqueous_1"], volume = 12000),
dict(address =  run_stock_aqueous_2, name =  stock_names["run_stock_aqueous_2"], volume = 12000),
